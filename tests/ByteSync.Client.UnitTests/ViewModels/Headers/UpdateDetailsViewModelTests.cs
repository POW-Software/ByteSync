...
namespace ByteSync.Client.UnitTests.ViewModels.Headers;
...
public class UpdateDetailsViewModelTests
{
    ...
    public void SetUp()
    {
        ...
        // Use an immediate synchronization context so Progress reports inline during tests
    ...
    public void UpdateManager_ProgressReported_Should_Update_Progress_For_Downloading()
    {
        // Arrange
        var viewModel = CreateViewModel();
        using var _ = viewModel.Activator.Activate(); // Activate to trigger WhenActivated
