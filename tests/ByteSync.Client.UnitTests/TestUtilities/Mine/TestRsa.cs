...
namespace ByteSync.Client.UnitTests.TestUtilities.Mine;
...
public class TestRsa
{
    ...
    public void Test1_DifferentMessages()
    {
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            encryptedMessages.Any(em => em.SequenceEqual(encryptedMessage)).Should()
                .BeFalse(); // We should not have encountered this publicKey yet
