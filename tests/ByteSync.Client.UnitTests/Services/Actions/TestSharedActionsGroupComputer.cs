...
namespace ByteSync.Client.UnitTests.Services.Actions;
...
public class TestSharedActionsGroupComputer : AbstractTester
{
    ...
    public void SetUp()
    {
        ...
        _sharedActionsGroupComputer =
            new SharedActionsGroupComputer(_sharedAtomicActionRepository.Object, _sharedActionsGroupRepository.Object);
    }
    ...
    public async Task Test_2Actions_1Source_2Targets_2()
    {
        ...
        sharedAtomicAction2 = new SharedAtomicAction("SAA2");
        sharedAtomicAction2.PathIdentity = new PathIdentity(FileSystemTypes.File, "file1.txt", "file1.txt", "file1.txt");
        sharedAtomicAction2.Source = SharedDataPartTestFactory.Create("A1", FileSystemTypes.Directory, "CII_A", "A", "D:\\", "file1.txt",
            "SigGuidA", "SigHashA", false);
