...
namespace ByteSync.Client.UnitTests.Services.Announcements;
...
public class AnnouncementServiceTests
{
    ...
    private class TestAnnouncementService : AnnouncementService
    {
        ...
        public TestAnnouncementService(IAnnouncementApiClient apiClient, IAnnouncementRepository repository,
            ILogger<AnnouncementService> logger, TimeSpan delay)
    ...
    public async Task Start_ShouldRefreshAnnouncementsPeriodically()
    {
        ...
        using var service =
            new TestAnnouncementService(_apiClient.Object, _repository.Object, _logger.Object, TimeSpan.FromMilliseconds(50));
