...
public class PropertyComparisonExpressionEvaluatorTests
{
    ...
    {
        var path = new PathIdentity(FileSystemTypes.File, "/f.txt", "f.txt", "/f.txt");
    ...
    {
        var extractor = new Mock<IPropertyValueExtractor>();
    ...
    {
        var evaluator = CreateEvaluatorReturning(Numbers(2048));
        var expr = new PropertyComparisonExpression(new DataPart("A1"), Identifiers.PROPERTY_SIZE, ComparisonOperator.GreaterThan, null,
            "1024");
    ...
    public void CompareWithLiteral_LastWriteTime_WithNowDuration_ParsesAndCompares()
    {
        ...
        var expr = new PropertyComparisonExpression(new DataPart("A1"), Identifiers.PROPERTY_LAST_WRITE_TIME,
            ComparisonOperator.GreaterThan, null, "now-1m");
    ...
    public void CompareWithLiteral_LastWriteTime_InvalidNowDuration_ReturnsFalse()
    {
        ...
        var expr = new PropertyComparisonExpression(new DataPart("A1"), Identifiers.PROPERTY_LAST_WRITE_TIME, ComparisonOperator.Equals,
            null, "now-10x");
