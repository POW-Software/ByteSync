...
public class IdentityBuilderTests : AbstractTester
{
    ...
    public void Test_FileDescriptionInDirectory(string fileRelativePath)
    {
        ...
        var fileDescription = Services.Comparisons.IdentityBuilder.BuildFileDescription(inventoryBuilder.Inventory!.InventoryParts.Single(), file1);
    ...
    public void Test_DirectoryDescriptionInDirectory(string directoryRelativePath)
    {
        ...
        var fileDescription = Services.Comparisons.IdentityBuilder.BuildDirectoryDescription(inventoryBuilder.Inventory!.InventoryParts.Single(), subDirectory);
