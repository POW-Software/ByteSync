...
public class DataSourceCodeGeneratorTests
{
    ...
    public void Codes_Assigned_Sequentially_OnAdd()
    {
        ...
        var ds2 = new DataSource
            { DataNodeId = node.Id, ClientInstanceId = "CID0", Path = "path2", InitialTimestamp = DateTime.Now.AddMilliseconds(1) };
    ...
    public void Codes_Renumber_OnRemove()
    {
        ...
        var ds3 = new DataSource
            { DataNodeId = node.Id, ClientInstanceId = "CID0", Path = "path3", InitialTimestamp = DateTime.Now.AddMilliseconds(2) };
        _dataSourceRepository.AddOrUpdate([ds1, ds2, ds3]);
    ...
    public void Codes_Update_WhenNodeCodeChanges()
    {
        ...
        var ds2 = new DataSource
            { DataNodeId = node.Id, ClientInstanceId = "CID0", Path = "path2", InitialTimestamp = DateTime.Now.AddMilliseconds(1) };
        _dataSourceRepository.AddOrUpdate([ds1, ds2]);
