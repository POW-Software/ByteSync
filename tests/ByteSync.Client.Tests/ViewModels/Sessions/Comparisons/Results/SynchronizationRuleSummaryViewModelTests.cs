...
namespace ByteSync.Tests.ViewModels.Sessions.Comparisons.Results;
...
public class SynchronizationRuleSummaryViewModelTests
{
    ...
    private void UseRealDescriptionFactory()
    {
        ...
        _descriptionBuilderFactory.Setup(f => f.CreateSynchronizationRuleDescriptionBuilder(It.IsAny<ByteSync.Interfaces.Business.Actions.ISynchronizationRule>()))
            .Returns<ByteSync.Interfaces.Business.Actions.ISynchronizationRule>(r => new SynchronizationRuleDescriptionBuilder(r, _localizationService.Object, realFactory));
    }
