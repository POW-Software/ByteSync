...
public class TestAtomicActionConsistencyChecker : IntegrationTest
{
    ...
    [Test]
    [TestCase(DataTypes.Directories, MatchingModes.Tree, 1)]
    [TestCase(DataTypes.Files, MatchingModes.Tree, 1)]
    [TestCase(DataTypes.FilesDirectories, MatchingModes.Tree, 2)]
    [TestCase(DataTypes.Directories, MatchingModes.Flat, 1)]
    [TestCase(DataTypes.Files, MatchingModes.Flat, 1)]
    [TestCase(DataTypes.FilesDirectories, MatchingModes.Flat, 2)]
    public async Task Test_DirectoryOnlyOnA_3(DataTypes dataType, MatchingModes matchingMode,
        int comparisonItemViewModelsCount)
    {
        ...
        var cloudSessionSettings = SessionSettingsGenerator.GenerateSessionSettings(dataType, matchingMode);
