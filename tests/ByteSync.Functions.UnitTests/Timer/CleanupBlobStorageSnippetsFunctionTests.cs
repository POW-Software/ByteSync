...
//
// [TestFixture]
// public class CleanupBlobStorageSnippetsFunctionTests
// {
//     private Mock<IBlobContainerProvider> _mockBlobContainerProvider = null!;
//     private Mock<ILogger<CleanupBlobStorageSnippetsFunction>> _mockLogger = null!;
//     
//     [SetUp]
//     public void SetUp()
//     {
//         _mockLogger = new Mock<ILogger<CleanupBlobStorageSnippetsFunction>>();
...
//
//         var cleanupBlobFilesFunction = new CleanupBlobStorageSnippetsFunction(configuration, _mockBlobContainerProvider.Object , _mockLogger.Object);
//
//         // Act
