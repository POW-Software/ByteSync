...
public class DateAndInventoryPartsViewModel : ViewModelBase
{
    ...
    public DateAndInventoryPartsViewModel(ContentIdentityViewModel contentIdentityViewModel, DateTime lastWriteTimeUtc,
        HashSet<InventoryPart> inventoryParts,
        ISessionService sessionService, ILocalizationService localizationService)
    {
        ...
        if (sessionService.CurrentSessionSettings!.MatchingMode == MatchingModes.Flat ||
