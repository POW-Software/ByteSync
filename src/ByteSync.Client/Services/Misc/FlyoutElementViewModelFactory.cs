...
public class FlyoutElementViewModelFactory : IFlyoutElementViewModelFactory
{
    ...
    public AddTrustedClientViewModel BuilAddTrustedClientViewModel(PublicKeyCheckData publicKeyCheckData,
    ...
    public SynchronizationRuleGlobalViewModel BuilSynchronizationRuleGlobalViewModel(SynchronizationRule synchronizationRule,
        bool isCloneMode)
    {
